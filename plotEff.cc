...
void plotEffBin(int q2Bin, int parity, int altIndx, bool doClosure)
{
  ...
  string filename_data = Form("/lustre/cmswork/boletti/Kstmumu-Run2/datasets/PUweight/effDataset_b%i.root",q2Bin);
  ...
  if ( !effCHist || !effWHist || effCHist->IsZombie() || effWHist->IsZombie() ) {
