...
void fit_recoMC_singleComponentBin(int q2Bin, int parity, int tagFlag, bool plot, bool save)
{
  ...
  if (tagFlag==1) PDF_sig_ang_singleComponent = new PdfRT("PDF_sig_ang_singleComponent","PDF_sig_ang_singleComponent",*ctK,*ctL,*phi,*Fl,*P1,*P2,*P3,*P4p,*P5p,*P6p,*P8p,*eff,intVec);
  else            PDF_sig_ang_singleComponent = new PdfWT("PDF_sig_ang_singleComponent","PDF_sig_ang_singleComponent",*ctK,*ctL,*phi,*Fl,*P1,*P2,*P3,*P4p,*P5p,*P6p,*P8p,*eff,intVec);
